...
en_model = StanfordCoreNLP(r'/home/admindell/Documents/topic-modelling/stanford-corenlp-latest',quiet=True)#download from https://stanfordnlp.github.io/CoreNLP/
...
print(keyphrases)
print(keyphrases_)
#pip install allennlp==0.8.4  --no-cache-dir